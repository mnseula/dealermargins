...
LEFT JOIN (
    ...
    FROM (
        ...
        UNION ALL
        SELECT CfgValue, CfgName, BoatSerialNo FROM warrantyparts.BoatOptions24
        UNION ALL
        SELECT CfgValue, CfgName, BoatSerialNo FROM warrantyparts.BoatOptions25
        UNION ALL
        SELECT CfgValue, CfgName, BoatSerialNo FROM warrantyparts.BoatOptions26
    ) all_boats
