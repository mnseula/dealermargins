#!/usr/bin/env python3
"""
Populate MySQL BoatOptions25 table from MSSQL source data
Extracts physical items (excludes configuration items) from sales orders
"""
import pymssql
import pymysql
...
def main():
    ...
    try:
        ...
        print(f"✅ Extracted {len(rows):,} rows from MSSQL\n")
        ...
        print("Sample boats with item counts:")
