...
if (hasAnswer('LAYOUT', 'PORTRAIT')) {
    ...
    flyerbody += "    <div id = \"title2\">" + (document.getElementById('model') ? document.getElementById('model').value : '') + "<\/div>";
    flyerbody += "    <div id = \"power\">POWER<\/div>";
    flyerbody += "    <div id = \"powerContent\">" + (document.getElementById('engine') ? document.getElementById('engine').value : '') + "<\/div>";
    flyerbody += "    <div id = \"length\">LENGTH<\/div>";
    flyerbody += "    <div id = \"lengthContent\">" + (document.getElementById('loa') ? document.getElementById('loa').value : '') + "<\/div>";
    flyerbody += "    <div id = \"beam\">BEAM<\/div>";
    flyerbody += "    <div id = \"beamContent\">" + (document.getElementById('beam') ? document.getElementById('beam').value : '') + "<\/div>";
    flyerbody += "    <div id = \"dia\">PONTOON DIA<\/div>";
    flyerbody += "    <div id = \"diaContent\">" + (document.getElementById('diameter') ? document.getElementById('diameter').value : '') + "<\/div>";
    flyerbody += "    <div id = \"capacity\">CAPACITY<\/div>";
    flyerbody += "    <div id = \"capacityContent\">" + (document.getElementById('cap') ? document.getElementById('cap').value : '') + "<\/div>";
    flyerbody += "    <div id = \"hull\">HULL WEIGHT<\/div>";
    flyerbody += "    <div id = \"hullContent\">" + (document.getElementById('weight') ? document.getElementById('weight').value : '') + "<\/div>";
    flyerbody += "    <div id = \"fuel\">FUEL CAPACITY<\/div>";
    flyerbody += "    <div id = \"fuelContent\">" + (document.getElementById('fuel') ? document.getElementById('fuel').value : '') + "<\/div>";
    ...
    flyerbody += "    <div id = \"optionalMessage\">" + optionalMessage + "<\/div>";
    flyerbody += "    ";
    flyerbody += "<\/body>";
    flyerbody += "<\/html>";
    flyerbody += "";
